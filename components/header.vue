<template>
	<header class="h-[70px] bg-primary shadow-lg fixed w-full">
		<div
			class="max-w-screen-xl sm:px-2.5 lg:px-0 flex justify-between mx-auto"
		>
			<h1 class="w-fit">
				<NuxtLink to="/"
					><img src="/image/logo-large.svg" alt=""
				/></NuxtLink>
			</h1>
			<nav>
				<ul class="flex list-none items-center h-full">
					<li
					...
					>
						<NuxtLink
							...
							@click="openMenu()"
						>
							<template v-if="navItem.iconOnly">
...
<script setup>
const navItems = ref([
	{ name: '所有商品', source: 'products' },
	{ name: '實體概念店', source: 'shop' },
	{ name: '貓星人的推薦', source: 'reccomend' },
	{ name: '常見問題', source: 'Q&As' },
	{ iconOnly: true, name: '會員專區', source: 'member' },
	{ iconOnly: true, name: '購物車', source: 'shopping-cart' },
]);
</script>
<style scoped></style>
