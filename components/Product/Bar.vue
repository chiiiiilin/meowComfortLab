<template>
	<NuxtLink
		class="group card glass w-full h-auto px-3 py-1 hover:shadow-md transition duration-500 ease-in-out grid grid-cols-5 gap-4 items-center text-center cursor-pointer"
